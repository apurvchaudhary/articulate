...
class Article(models.Model):
    ...
    type = models.CharField(
        verbose_name="Type", max_length=50, choices=TYPE_CHOICE, default=TYPE_CHOICE[4][0], help_text="default is Movie"
    )
    ...
    embed_link = models.URLField(
        verbose_name="Trailer Youtube Link", blank=True, null=True, help_text="Paste only youtube urls"
    )
